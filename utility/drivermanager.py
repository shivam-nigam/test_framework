...
class DriverManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #self.driver = webdriver.Firefox(self.ffprofile,executable_path=r'E:\\PWAF\drivers\geckodriver.exe')
        self.driver = webdriver.Chrome(executable_path="E:\\empirix\drivers\chromedriver.exe")
